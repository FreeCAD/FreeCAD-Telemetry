...
class Preferences:
    ...
    def _enable_check_state_changed(self, check_state):
        ...
        if check_state == QtGui.Qt.CheckState.Checked:
    ...
    def _data_removal_clicked(self):
        ...
        if ok:
            ...
            ParamGet("User parameter:BaseApp/Preferences/Mod/Telemetry").SetString(
                "PostHogUUID", "unset"
            )
        QtWidgets.QMessageBox.information(
            None,
            Qt.translate("Telemetry", "Deletion request response"),
            message,
